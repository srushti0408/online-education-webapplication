...
public class CertificateController {
	...
	String Certificate(Model model, @PathVariable("courseTitle") String courseTitle,
		...
		String path="D:\\Spring MVC Project\\Online-Education-Webapp-SemiFinal\\Online-Education-Webapp-SemiFinal\\src\\main\\resources\\static\\certificates\\Certificate.png";
